  ...
  return (
    <div className="w-full bg-[#ebecec] pb-10">
      <div className="flex justify-between pt-12 mx-16">
        <h3 className="text-[#0487E2] text-2xl font-semibold">Pooley&apos;s</h3>
        <div className="flex">
          <button className="bg-[#0487E2] text-white p-1.5 pl-3 rounded flex gap-1.5 items-center justify-center hover:bg-[#169dfd]">
            View All <Image src={rightCheveron} alt="rightCheveron" />
          </button>
        </div>
      </div>
